...
const PALETTE: { value: string; label: string }[] = [
  ...
  { value: "#8a4a5a", label: "plum" },
  { value: "#6a6a3a", label: "olive" },
  { value: "#5a4a3a", label: "clay" },
]
...
export function CharacterDetailDialog({
  ...
  const title = isNew ? "New character" : editing ? "Edit character" : character.name
      ...
      {editing ? (
        ...
        <div className="flex flex-col gap-4">
          <label className="flex flex-col gap-1">
            ...
            <input
              ...
              placeholder="e.g. Dmitri Fyodorovich Karamazov"
          ...
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={4}
              placeholder="Short description, no spoilers…"
              className={inputClass}
            />
          </label>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs font-serif text-muted-foreground">
            ...
            <span>appears in ch. {character.appearsInChapter}</span>
            <span>
